...
_RAW_QUESTIONS = [
    ("q1", "Te ofrecen dos oportunidades increíbles el mismo día. ¿Qué haces?", [
        ("Acepto la que se sienta más emocionante, ya luego resuelvo", ["Aries", "Sagitario"]),
    ...
    ("q2", "Es viernes en la noche, ¿qué plan te prende más?", [
        ("Algo de adrenalina o un reto físico de último momento", ["Aries", "Sagitario"]),
        ("Pijama, comida a domicilio y una serie nueva", ["Tauro", "Cáncer"]),
        ("Antro o fiesta, conocer gente nueva toda la noche", ["Leo", "Libra"]),
    ...
    ("q3", "En un trabajo en equipo (escuela o chamba), tú eres quien...", [
        ...
        ("Revisa que no haya ni una falta de ortografía", ["Virgo", "Capricornio"]),
        ("Calma los dramas cuando alguien se pelea", ["Libra", "Tauro"]),
        ("Propone la idea que a nadie más se le ocurrió", ["Acuario", "Géminis"]),
    ]),
    ("q4", "Alguien comenta algo feo en tus redes. ¿Qué haces?", [
        ("Respondo al toque, no me quedo callado(a)", ["Aries", "Leo"]),
        ("Me lo creo y me arruina el día por completo", ["Cáncer", "Piscis"]),
        ("Analizo fríamente si tiene algo de razón", ["Virgo", "Capricornio"]),
        ("Bloqueo y sigo con mi vida, ni tiempo pierdo", ["Tauro", "Sagitario"]),
    ]),
    ("q5", "Te cae dinero extra (beca, regalo, propina grande). ¿Qué haces?", [
        ("Me lo gasto en una experiencia o viaje ya mismo", ["Aries", "Sagitario"]),
        ("Lo guardo, uno nunca sabe cuándo lo va a necesitar", ["Tauro", "Capricornio"]),
        ("Invito a mi gente favorita, se disfruta mejor así", ["Cáncer", "Piscis"]),
        ("Lo invierto en algo (curso, gadget, cripto, lo que sea)", ["Géminis", "Acuario"]),
    ]),
    ("q6", "Truena una discusión fuerte con tu crush, pareja o mejor amigo(a). Tú...", [
        ...
        ("Me quedo en shock y lo proceso horas después, solo(a)", ["Tauro", "Cáncer"]),
        ("Trato de resolverlo hablando con calma", ["Géminis", "Libra"]),
        ("Lo digo derechito, sin rodeos ni drama extra", ["Leo", "Sagitario"]),
    ]),
    ...
    ("q8", "Planeas un viaje con amigos. Tú eres quien...", [
        ("Dice \"ya nos organizamos allá\", cero plan armado", ["Aries", "Sagitario"]),
        ...
        ("Busca el lugar más random que nadie más conoce", ["Escorpio", "Acuario"]),
    ]),
    ("q9", "Así muestras que alguien te importa de verdad...", [
        ("Con acciones, apareces justo cuando te necesitan", ["Aries", "Cáncer"]),
    ...
    ("q10", "Cancelan tu plan de última hora. ¿Cómo reaccionas?", [
        ("Mejor, invento algo nuevo al toque", ["Aries", "Géminis"]),
        ("Me estresa, ya tenía todo listo en mi cabeza", ["Tauro", "Capricornio"]),
        ("Me pega más de lo que debería, ni sé por qué", ["Cáncer", "Piscis"]),
        ("Lo tomo como señal de que algo mejor viene", ["Sagitario", "Acuario"]),
    ]),
    ("q11", "En el chat grupal, tú eres el/la que...", [
        ("Manda mensajes directos, sin rodeos", ["Aries", "Sagitario"]),
        ("Pregunta \"¿todo bien?\" en cuanto alguien anda raro", ["Cáncer", "Tauro"]),
    ...
    ("q12", "Lo que jamás perdonas en una amistad es...", [
        ("Que me dejen plantado(a) sin avisar", ["Aries", "Sagitario"]),
        ("Que prometan algo y no lo cumplan", ["Tauro", "Capricornio"]),
        ("Que no me escuchen de verdad, solo esperen su turno de hablar", ["Cáncer", "Piscis"]),
        ("Que sean aburridos, necesito buena plática", ["Géminis", "Acuario"]),
    ]),
    ("q13", "Semana de exámenes o entregas. ¿Cómo sobrevives?", [
        ("Con ejercicio, necesito gastar toda esa energía", ["Aries", "Leo"]),
        ("Comiendo algo rico sin ninguna culpa", ["Tauro", "Cáncer"]),
        ("Desaparezco del radar un rato, nadie me encuentra", ["Escorpio", "Piscis"]),
        ("Haciendo listas y horarios hasta el último minuto", ["Virgo", "Capricornio"]),
    ]),
    ("q14", "Vas a aprender algo nuevo (skill, idioma, deporte). Tú...", [
        ("Te avientas sin tutorial, aprendes cayéndote", ["Aries", "Escorpio"]),
        ("Practicas todos los días hasta dominarlo por completo", ["Tauro", "Capricornio"]),
        ("Ves veinte videos de YouTube antes de siquiera empezar", ["Géminis", "Sagitario"]),
        ("Te armas tu propio método, paso a paso", ["Virgo", "Acuario"]),
    ]),
    ("q15", "En una fiesta o reunión, tú eres...", [
        ("El alma de la fiesta, la pasas increíble", ["Leo", "Sagitario"]),
    ...
    ("q16", "Lo que de verdad te mueve en la vida es...", [
        ...
        ("Entender cómo funciona absolutamente todo", ["Géminis", "Sagitario", "Acuario"]),
    ]),
    ("q17", "Metiste la pata en algo importante. ¿Qué haces?", [
        ("Sigo adelante, ya fue, no me quedo pensando en eso", ["Aries", "Sagitario"]),
        ("Me atormento días enteros dándole vueltas", ["Virgo", "Capricornio"]),
        ("Me destroza emocionalmente por un buen rato", ["Cáncer", "Piscis"]),
        ("\"Ya qué, mañana es otro día\"", ["Tauro", "Géminis", "Leo"]),
    ]),
    ("q18", "Tu rutina ideal de vida sería...", [
        ("Que cada día sea distinto, odio la monotonía", ["Aries", "Géminis", "Sagitario"]),
        ("Bien estructurada, saber exactamente qué esperar", ["Tauro", "Virgo", "Capricornio"]),
